...
const APP = (() => {
  ...
  function switchTab(tabId) {
    ...
    const titles = {
      home: '<div style="display: flex; align-items: center; gap: 6px;"><img src="images/logo/logo-transparent.png" alt="Solar Rex Icon" style="height: 24px; width: auto; object-fit: contain;"><img src="images/logo/solar-rex-text-clean.png" alt="Solar Rex" style="height: 22px; width: auto; object-fit: contain;"></div>',
      solutions: 'Solutions',
    ...
    if (h) h.innerHTML = titles[tabId] || '<div style="display: flex; align-items: center; gap: 6px;"><img src="images/logo/logo-transparent.png" alt="Solar Rex Icon" style="height: 24px; width: auto; object-fit: contain;"><img src="images/logo/solar-rex-text-clean.png" alt="Solar Rex" style="height: 22px; width: auto; object-fit: contain;"></div>';
  ...
  function buildHeader() {
    ...
    h.innerHTML = `
      <div class="app-header-title"><div style="display: flex; align-items: center; gap: 6px;"><img src="images/logo/logo-transparent.png" alt="Solar Rex Icon" style="height: 24px; width: auto; object-fit: contain;"><img src="images/logo/solar-rex-text-clean.png" alt="Solar Rex" style="height: 22px; width: auto; object-fit: contain;"></div></div>
      ...
      entries.forEach(entry => {
        if (entry.isIntersecting) {
          ...
          if (tab !== currentTab) {
            ...
            const h = $('.app-header-title');
            if (h) h.innerHTML = titles[tab] || '<div style="display: flex; align-items: center; gap: 6px;"><img src="images/logo/logo-transparent.png" alt="Solar Rex Icon" style="height: 24px; width: auto; object-fit: contain;"><img src="images/logo/solar-rex-text-clean.png" alt="Solar Rex" style="height: 22px; width: auto; object-fit: contain;"></div>';
          }
        }
      });
    }, { threshold: 0.3 });
