...
graph TD
    ...
    SendAPI --> ProxyFunction\[Serverless Function Reads GOOGLE\_SCRIPT\_URL from Env]
...
```env
GOOGLE\_SCRIPT\_URL=your\_google\_script\_web\_app\_url\_here
```

When deploying to Vercel, navigate to the project dashboard and add `GOOGLE\_SCRIPT\_URL` to **Settings ➔ Environment Variables**.
